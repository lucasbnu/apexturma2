...
public class FuncionariosView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        edtIDfuncionario = new javax.swing.JTextField();
        ...
        edtIDfuncionario.setEditable(false);

        jLabel2.setText("Nome do Funcionario");

        edtnomeFuncionario.setEditable(false);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(edtnomeFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(edtIDfuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(100, 100, 100)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel1)
                            .addComponent(edtIDfuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
    ...
    private void modoEdicao(boolean editando){
        ...
        edtnomeFuncionario.setEditable(editando);
    ...
    private void btnconfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnconfirmarActionPerformed
        ...
        cli.setNome_funcionario(edtnomeFuncionario.getText());
        cli.setSituacao(edtSituacao.getText().charAt(0));
        if (acao == 1){
           comando.insereRegistro(cli);
        }else{
           cli.setId_funcionario(Integer.parseInt(edtIDfuncionario.getText()));
    ...
    private void btnapagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnapagarActionPerformed
        ...
        FuncionariosDTO cli = new FuncionariosDTO();
        ComandosDAO comando = new ComandosDAO();
        mensagem = "Você realmente deseja apagar o funcionario:\n"+
                   edtnomeFuncionario.getText()+"\n"+
                   "Essa ação não pode ser desfeita!";
        
        if (JOptionPane.showConfirmDialog(this, mensagem,"Apagando funcionario",0,2) == 0){
           cli.setId_funcionario(Integer.parseInt(edtIDfuncionario.getText()));
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        if (acao == 0){
        edtIDfuncionario.setText(tabela.getValueAt(tabela.getSelectedRow(), 0).toString());
        edtnomeFuncionario.setText( tabela.getValueAt(tabela.getSelectedRow(),1).toString() );
    ...
    private javax.swing.JTextField edtIDfuncionario;
